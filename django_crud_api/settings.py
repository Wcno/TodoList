...
SECRET_KEY = 'django-insecure-$_sxtlz1u+_jn*ix@(131$9rv$3g&yri7@#x@&%m@(mg)^jcvf'
...
INSTALLED_APPS = [
    ...
    'drf_spectacular',  # Core API for schema generation
...
REST_FRAMEWORK = {
    'DEFAULT_SCHEMA_CLASS': 'drf_spectacular.openapi.AutoSchema',  # Esto va aquí, no en CORS
}
